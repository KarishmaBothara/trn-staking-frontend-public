import { AuthMethod, UserAuthenticationMethod, hush } from 'common';
 ...
 *   ```
 */
function useAuthenticationMethod(): UserAuthenticationMethod | null {
...
export default createNamedHook('useAuthenticationMethod', useAuthenticationMethod);
