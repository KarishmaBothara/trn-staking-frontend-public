import { ReactComponent as Xaman } from '../../assets/svgs/Xaman.svg';
import { createNamedHook } from './createNamedHook';
import { UserAuthenticationMethod } from 'common';
...
const EMAIL_ICON = React.createElement('span', { className: 'material-symbols-outlined' }, 'email');
const USER_ICON = React.createElement('span', {}, '\u{1F464}');
const EOA = React.createElement(
  'span',
  { className: 'material-symbols-outlined' },
  'account_balance_wallet'
);

function useWalletAccountInfo(auth: UserAuthenticationMethod): WalletAccountInfo | null {
...
export default createNamedHook('useWalletAccountInfo', useWalletAccountInfo);
